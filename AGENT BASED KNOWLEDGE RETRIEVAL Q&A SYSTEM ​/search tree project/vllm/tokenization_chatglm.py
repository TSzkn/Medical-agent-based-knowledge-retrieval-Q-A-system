#这是一个修改过之后的版本适配vllm的，请勿随意使用。修改之前记得留一个备份
#
#
import json
import os
...
class SPTokenizer:
    ...
    def encode(self, s: str, bos: bool = False, eos: bool = False) -> List[int]:
        ...
        if eos:
            t = t + [self.eos_id]
        # logger.info("use tokenizer！！！&&&&&&&&& ")
        # logger.info(t)
        # print("use tokenizer!!!!")
        return t
        # return "standard token for mistakes"
...
class ChatGLMTokenizer(PreTrainedTokenizer):
    ...
    def build_single_message(self, role, metadata, message):
        ...
        # print("build_single_message!!!!!!!")
        # print(role)
        # print(message)
        # logging.info("build_single_message!!!!!!!")
        # logging.info(role)
